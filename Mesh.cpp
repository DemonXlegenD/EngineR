...
void Mesh::Draw(Shader& _shader, Camera& _camera, glm::mat4 _matrix, glm::vec3 _translation, glm::quat _rotation, glm::vec3 _scale)
{
    ...
    glUniform3f(glGetUniformLocation(_shader.ID, "camPos"), _camera.position.x, _camera.position.y, _camera.position.z);
    ...
    glUniformMatrix4fv(glGetUniformLocation(_shader.ID, "translation"), 1, GL_FALSE, glm::value_ptr(trans));
    glUniformMatrix4fv(glGetUniformLocation(_shader.ID, "rotation"), 1, GL_FALSE, glm::value_ptr(rot));
    glUniformMatrix4fv(glGetUniformLocation(_shader.ID, "scale"), 1, GL_FALSE, glm::value_ptr(sca));
    glUniformMatrix4fv(glGetUniformLocation(_shader.ID, "model"), 1, GL_FALSE, glm::value_ptr(_matrix));
